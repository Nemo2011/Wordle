                        ...
                        if btn.rect.collidepoint(pos):
                            if index == 5:
                                ...
                                while going:
                                    ...
                                    btn2 = buttons.Button(self, 0, 150, (255, 255, 255), "2. Hard mode need: green stay fixed, yellow be reused. ", 1000, 50)
                                    btn3 = buttons.Button(self, 0, 200, (230, 230, 230), "3. You need to guess the word. ", 1000, 50)
