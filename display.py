...
class Display:
    ...
    def display(self):
        ...
        if mode == "ask":
            ...
            y = lst[0]
            btn = buttons.Button(
                self.wordle, 0, 0, (230, 230, 230), "WORDLE GAME", 1000, 100
            )
            btn.draw_button()
            if y == 2 and x == 1:
                pygame.draw.rect(self.scr, (0, 0, 0), pygame.Rect(145, 270, 185, 85))
            btn100 = buttons.Button(
                self.wordle, 150, 275, (0, 0, 255), "4", 175, 75, (255, 255, 255)
            )
            btn100.draw_button()
            if y == 1:
                pygame.draw.rect(self.scr, (0, 0, 0), pygame.Rect(145, 145, 710, 85))
            btn5 = buttons.Button(
                self.wordle, 150, 150, (0, 0, 255), "5", 700, 75, (255, 255, 255)
            )
            btn5.draw_button()
            ...
            btn6 = buttons.Button(
                self.wordle, 350, 275, (0, 0, 255), "6", 175, 75, (255, 255, 255)
            )
            btn6.draw_button()
            ...
            if y == 2 and x == 3:
                ...
                pygame.draw.rect(
                    self.scr, (230, 230, 230), pygame.Rect(540, 245, 320, 140)
                )
            elif y == 2 and x == 4:
                if not self.wordle.stats.select_m:
            ...
            if self.wordle.stats.easy:
                ...
                easy = buttons.Button(
                    self.wordle, 550, 325, (0, 255, 0), "OFF", 100, 50, (255, 255, 255)
                )
                hard = buttons.Button(
                    self.wordle,
                    750,
                ...
                hard = buttons.Button(
                    self.wordle, 750, 325, (0, 255, 0), "ON", 100, 50, (255, 255, 255)
                )
            tip2 = buttons.Button(
                self.wordle,
                0,
                600,
                (255, 255, 255),
                "*Hard mode need: Green stay fixed, yellow be reused. ",
                1000,
                50,
            )
            tip2.draw_button()
            ...
            hlp = buttons.Button(
                self.wordle, 280, 400, (0, 0, 255), "GUIDE", 200, 100, (255, 255, 255)
            )
            hlp.draw_button()
            if y == 3 and x == 4:
            ...
            btn2 = buttons.Button(
                self.wordle, 40, 400, (0, 0, 255), "INFO", 200, 100, (255, 255, 255)
            )
            btn2.draw_button()
            if y == 3 and x == 3:
                pygame.draw.rect(self.scr, (0, 0, 0), pygame.Rect(515, 395, 210, 110))
            aut = buttons.Button(
                self.wordle, 520, 400, (0, 0, 255), "AUTHOR", 200, 100, (255, 255, 255)
            )
            aut.draw_button()
            ...
            if self.wordle.stats.cc:
                pygame.draw.rect(
                    self.scr, (255, 255, 255), pygame.Rect(0, 500, 1000, 150)
                )
                btn = buttons.Button(
                    self.wordle,
                    0,
                ...
                ans = buttons.Button(
                    ...
                    500,
                    (0, 0, 255),
                    self.wordle.stats.answer.upper(),
                    900,
                    75,
                    (255, 255, 255),
                )
                if self.wordle.stats.col != 0:
                    pygame.draw.rect(
                        self.scr,
                        (0, 0, 0),
                        pygame.Rect(self.wordle.stats.col * 330 - 330, 575, 340, 75),
                    )
                self.cc = buttons.Button(
                    self.wordle,
                    10,
                    585,
                    (0, 139, 0),
                ...
                self.si.draw_button()
                self.bck = buttons.Button(
                    self.wordle, 670, 585, (125, 125, 125), "BACK", 320, 55
                )
                ...
                self.q = buttons.Button(
                    self.wordle, 255, 505, self.wordle.stats.state["q"], "Q", 40, 40
                )
                self.w = buttons.Button(
                    self.wordle, 305, 505, self.wordle.stats.state["w"], "W", 40, 40
                )
                self.e = buttons.Button(
                    self.wordle, 355, 505, self.wordle.stats.state["e"], "E", 40, 40
                )
                self.r = buttons.Button(
                    self.wordle, 405, 505, self.wordle.stats.state["r"], "R", 40, 40
                )
                self.t = buttons.Button(
                    self.wordle, 455, 505, self.wordle.stats.state["t"], "T", 40, 40
                )
                self.y = buttons.Button(
                    self.wordle, 505, 505, self.wordle.stats.state["y"], "Y", 40, 40
                )
                self.u = buttons.Button(
                    self.wordle, 555, 505, self.wordle.stats.state["u"], "U", 40, 40
                )
                self.i = buttons.Button(
                    self.wordle, 605, 505, self.wordle.stats.state["i"], "I", 40, 40
                )
                self.o = buttons.Button(
                    self.wordle, 655, 505, self.wordle.stats.state["o"], "O", 40, 40
                )
                self.p = buttons.Button(
                    self.wordle, 705, 505, self.wordle.stats.state["p"], "P", 40, 40
                )
                self.a = buttons.Button(
                    self.wordle, 280, 555, self.wordle.stats.state["a"], "A", 40, 40
                )
                self.s = buttons.Button(
                    self.wordle, 330, 555, self.wordle.stats.state["s"], "S", 40, 40
                )
                self.d = buttons.Button(
                    self.wordle, 380, 555, self.wordle.stats.state["d"], "D", 40, 40
                )
                self.f = buttons.Button(
                    self.wordle, 430, 555, self.wordle.stats.state["f"], "F", 40, 40
                )
                self.g = buttons.Button(
                    self.wordle, 480, 555, self.wordle.stats.state["g"], "G", 40, 40
                )
                self.h = buttons.Button(
                    self.wordle, 530, 555, self.wordle.stats.state["h"], "H", 40, 40
                )
                self.j = buttons.Button(
                    self.wordle, 580, 555, self.wordle.stats.state["j"], "J", 40, 40
                )
                self.k = buttons.Button(
                    self.wordle, 630, 555, self.wordle.stats.state["k"], "K", 40, 40
                )
                self.l = buttons.Button(
                    self.wordle, 680, 555, self.wordle.stats.state["l"], "L", 40, 40
                )
                self.z = buttons.Button(
                    self.wordle, 305, 605, self.wordle.stats.state["z"], "Z", 40, 40
                )
                self.x = buttons.Button(
                    self.wordle, 355, 605, self.wordle.stats.state["x"], "X", 40, 40
                )
                self.c = buttons.Button(
                    self.wordle, 405, 605, self.wordle.stats.state["c"], "C", 40, 40
                )
                self.v = buttons.Button(
                    self.wordle, 455, 605, self.wordle.stats.state["v"], "V", 40, 40
                )
                self.b = buttons.Button(
                    self.wordle, 505, 605, self.wordle.stats.state["b"], "B", 40, 40
                )
                self.n = buttons.Button(
                    self.wordle, 555, 605, self.wordle.stats.state["n"], "N", 40, 40
                )
                self.m = buttons.Button(
                    self.wordle, 605, 605, self.wordle.stats.state["m"], "M", 40, 40
                )
                self.back = buttons.Button(
                    self.wordle,
                    255,
                    605,
                    (125, 125, 125),
                ...
                if (
                    (not self.wordle.stats.win)
                    and (self.wordle.stats.round != 1)
                    and (self.wordle.stats.round != 6 or not self.wordle.stats.win)
                ):
                    self.give = buttons.Button(
                        self.wordle, 705, 605, (0, 139, 0), "?", 40, 40, (255, 255, 255)
                    )
                ...
                for letter in range(self.wordle.stats.letters):
                    if round + 1 >= self.wordle.stats.round:
                        ...
                        x = (
                            letter * 75
                            + (letter + 1) * 8
                            + (1000 - num * 75 - (num + 1) * 8) / 2
                        )
                        y = round * 75 + (round + 1) * 8
                        if (
                            self.wordle.stats.win
                            and round + 1 == self.wordle.stats.round
                        ):
                            pass
                        else:
                            pygame.draw.rect(
                                self.scr, (0, 0, 0), pygame.Rect(x, y, 75, 75)
                            )
                        if (
                            round + 1 == self.wordle.stats.round
                            and len(self.wordle.stats.type_word.upper()) > letter
                        ):
                            btn = buttons.Button(
                                self.wordle,
                                x + 5,
                                y + 5,
                                (255, 255, 255),
                                self.wordle.stats.type_word.upper()[letter],
                                65,
                                65,
                            )
                        else:
                            btn = buttons.Button(
                                self.wordle, x + 5, y + 5, (255, 255, 255), "", 65, 65
                            )
                        btn.draw_button()
                    ...
                    if self.wordle.stats.win and round + 1 == self.wordle.stats.round:
                        ...
                        btn.draw_button()
                        self.letters.append(btn)
                self.prnsc = buttons.Button(
                    self.wordle, 800, 700, (197, 180, 102), "SAVE", 200, 100
                )
