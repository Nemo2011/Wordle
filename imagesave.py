...
class ImageSave:
    ...
    def save(self):
        ...
        going = True
        while going:
            btn = buttons.Button(self.wordle, 300, 300, (0, 0, 255), "Type-in the location: ", 400, 100)
            t1 = buttons.Button(self.wordle, 0, 550, (255, 255, 255), r"You can type in ':' with key [;], '\' and '/' with [/] and [\].", 1000, 50)
            t2 = buttons.Button(self.wordle, 0, 600, (255, 255, 255), "You can type in lower letters. Upper letters use [SHIFT]. EG:[u]+[SHIFT]=[U].", 1000, 50)
            t3 = buttons.Button(self.wordle, 0, 650, (255, 255, 255), "You can use [BACKSPACE] and [ENTER]. ", 1000, 50)
            btn.draw_button()
            t1.draw_button()
            t2.draw_button()
            t3.draw_button()
